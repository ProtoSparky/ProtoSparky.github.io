function parseMIMEType(mimeType) {
  ...
  // Return the file type and file extension
  return { fileType: type, fileExtension: subtype, fileExtentionReady:"."+subtype};
}
function removeFileExtension(fileName) {
  // Find the last occurrence of the dot (.) to identify the file extension
  const lastDotIndex = fileName.lastIndexOf(".");  
  // If there is no dot or it is at the start, return the original string
